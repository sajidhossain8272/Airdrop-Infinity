  ...
  return (
        ...
        <div className="flex gap-4 px-4 lg:px-0 lg:justify-center py-2">
          {prices.map(coin => {
            ...
            return (
              ...
              >
                <span className="text-xl">{COINS.find(c => c.id === coin.id)?.icon}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg flex gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                In September 2020, Uniswap distributed <strong>400 UNI</strong> to every past user—
                worth over <strong>$12,000</strong> at the time, netting many early adopters a
                <strong>100×</strong> windfall.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg flex gap-6">
            ...
            <div>
              ...
              <p className="text-gray-700">
                December 2020 saw 1inch retro airdrop to liquidity providers—some users walked
                away with <strong>thousands of dollars</strong> just for early participation.
              </p>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative bg-white p-12 rounded-3xl shadow-2xl text-center overflow-hidden">
        ...
        <h2 className="text-4xl font-extrabold mb-2">Start Your Crypto Journey</h2>
        ...
        <p className="text-sm text-gray-500 mb-8">
          Join <span className="font-semibold text-indigo-600">100,000+</span> early adopters
          and claim yours today.
        </p>
          ...
          {journeyItems.map((item, idx) => (
            ...
            >
              <div className="bg-indigo-100 group-hover:bg-indigo-500 p-2 rounded-full transition-colors">
                {React.cloneElement(item.icon, { className: "text-xl text-indigo-600 group-hover:text-white" })}
              </div>
