  ...
  return (
    <section className='relative z-10 py-16 bg-gray-50 dark:bg-gray-950 transition-colors duration-300'>
        ...
        <div className='flex gap-4 px-4 lg:px-0 lg:justify-center py-2'>
          {prices.map((coin) => {
            ...
            return (
              ...
              <span className='font-semibold uppercase text-gray-700 dark:text-gray-200'>{coin.symbol}</span>
              <span className='text-gray-800 dark:text-gray-100'>${coin.current_price.toLocaleString()}</span>
          ...
          >
          <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-gray-950 dark:text-white mb-12">
          ...
          <div className="bg-white dark:bg-gray-900 bg-opacity-90 dark:bg-opacity-90 backdrop-blur-lg border-l-4 border-purple-500 p-6 rounded-2xl shadow-2xl hover:shadow-purple-300/50 transition duration-300 flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                ...
                <strong className="text-gray-900 dark:text-white">400 UNI</strong> to every past user—worth over{" "}
                <strong className="text-gray-900 dark:text-white">$12,000</strong> at the time. Early adopters netted a{" "}
                <strong className="text-gray-900 dark:text-white">100×</strong> return for simply trying the platform.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 bg-opacity-90 dark:bg-opacity-90 backdrop-blur-lg border-l-4 border-yellow-500 p-6 rounded-2xl shadow-2xl hover:shadow-yellow-300/50 transition duration-300 flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                ...
                <strong className="text-gray-900 dark:text-white">retroactive airdrops</strong>. Just by providing liquidity,
      ...
      >
        ...
        <div className="relative bg-white dark:bg-gray-900 p-12 rounded-3xl shadow-2xl text-center overflow-hidden border border-gray-200 dark:border-gray-800">
          {/* Heading */}
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
            Join <span className="font-semibold text-indigo-600 dark:text-indigo-400">100,000+</span> early adopters and claim yours today.
          </p>
          ...
          >
            {journeyItems.map((item, idx) => (
              ...
              >
                <div className="bg-indigo-100 dark:bg-indigo-900 group-hover:bg-indigo-500 p-2 rounded-full transition-colors">
                  {React.cloneElement(item.icon, {
                    className: "text-xl text-indigo-600 dark:text-indigo-300 group-hover:text-white",
                  })}
                </div>
                <p className="text-gray-800 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition">
                  {item.text}
                </p>
              </motion.li>
            ))}
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4">
            ...
            <Link
              to="/blog"
              className="inline-flex items-center justify-center px-6 py-3 border-2 border-purple-600 dark:border-purple-400 text-purple-600 dark:text-purple-300 rounded-full hover:bg-purple-600 dark:hover:bg-purple-400 hover:text-white transition"
            >
