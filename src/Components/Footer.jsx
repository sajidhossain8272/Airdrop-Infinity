...
<hr className="h-2 w-5/6 bg-gradient-to-r from-blue-900 via-purple-700 to-pink-600
...
<footer className="footer footer-center bg-base-100 text-black-content p-10">
  <aside>
    ...
    <p className="lato-bold text-2xl">
      Airdrop Infinity </p>
      <p className="text-lg lato-bold text-gray-700">
      Brings you the best crypto airdrops! </p>
      <nav>
