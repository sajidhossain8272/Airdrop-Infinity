  ...
  return (
    <div className='min-h-screen bg-base-100 lato-relative overflow-hidden bg-gradient-to-r from-blue-900/5 via-purple-700/5 to-pink-600/5 relative z-10'>
      ...
      <section className='relative overflow-hidden h-[700px] flex items-center justify-center'>
        ...
        <div className='absolute inset-0 overflow-hidden'>
          <div
            className='absolute w-[200%] h-[200%] animate-rotate-lines'
            style={{
          ...
          >
            ...
            <div className='mt-16 flex justify-center space-x-12'>
              <Link to='/blog' className='inline-block'>
                ...
                >
                  <FaBookOpen className='text-7xl text-purple-400/80 hover:text-purple-300 transition-colors duration-300 cursor-pointer' />
                </motion.div>
              </Link>

              <Link to='/listed-airdrop' className='inline-block'>
                <motion.div
                  animate={{ y: [0, -20, 0] }}
                  transition={{
                    duration: 4,
                ...
                >
                  <FaGift className='text-7xl text-blue-400/80 hover:text-blue-300 transition-colors duration-300 cursor-pointer' />
                </motion.div>
              </Link>
            </div>
          </motion.div>
