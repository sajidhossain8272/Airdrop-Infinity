const Privacy = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg mt-10 mb-10 transition-colors duration-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">5. Your Privacy Rights & Choices</h2>
      <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700 dark:text-gray-300">
        <li>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">6. Data Security & Disclaimer</h2>
      <p className="mb-6 text-gray-700 dark:text-gray-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">7. Children&apos;s Privacy</h2>
      <p className="mb-6 text-gray-700 dark:text-gray-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">8. Third-Party Links</h2>
      <p className="mb-6 text-gray-700 dark:text-gray-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">9. Limitation of Liability</h2>
      <p className="mb-6 text-gray-700 dark:text-gray-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">10. Changes to This Privacy Policy</h2>
      <p className="mb-6 text-gray-700 dark:text-gray-300">
      ...
      <h2 className="text-xl font-semibold mt-8 mb-3 text-gray-800 dark:text-gray-200">11. Contact Us</h2>
