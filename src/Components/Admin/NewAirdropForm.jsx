...
const NewAirdropForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Convert steps text area (one step per line) into an array of steps
  ...
  return (
    <div className="container mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Add New Airdrop</h1>
